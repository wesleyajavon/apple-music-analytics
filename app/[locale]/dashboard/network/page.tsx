      ...
      <div className="mb-6">
        ...
        {statsMeta && (
          <div className="mt-4 flex flex-wrap gap-4 text-sm text-gray-600 dark:text-gray-400">
            <span>
              <strong>{statsMeta.totalArtists}</strong> {t("artistsLabel")}
              {focusArtistId && ` ${t("egoView")}`}
            </span>
            <span>
              <strong>{statsMeta.totalConnections}</strong> {t("connectionsLabelShort")}
            </span>
          </div>
        )}
      </div>
            ...
            <div className="flex flex-wrap items-end gap-4">
              ...
              <div className="ml-auto flex items-center gap-4">
                <div className="flex items-center gap-2">
                  <span className="text-xs font-medium text-gray-600 dark:text-gray-400">{t("connectionsLabel")}</span>
                ...
                <button
                  type="button"
                  onClick={() => setFitViewTrigger((tr) => tr + 1)}
          ...
          <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <div className="mb-4 text-sm text-gray-600 dark:text-gray-400">
              ...
              <ul className="list-disc list-inside space-y-1">
                <li>{t("instructionHover")}</li>
                <li>{t("instructionEdge")}</li>
                <li>{t("instructionZoom")}</li>
                <li>{t("instructionOverview")}</li>
              </ul>
            </div>
