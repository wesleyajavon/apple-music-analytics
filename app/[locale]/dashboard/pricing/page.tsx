      ...
      <div className="max-w-4xl mx-auto text-center mb-12">
        ...
        <div className="mt-8 flex justify-center items-center gap-4">
          ...
          <span className={`text-sm ${billingCycle === 'yearly' ? 'text-gray-900 dark:text-white font-medium' : 'text-gray-500 dark:text-gray-400'}`}>
            {t("yearly")} <span className="text-blue-700 dark:text-blue-400 font-bold">{t("yearlyDiscount")}</span>
          </span>
        </div>
      </div>
        ...
        {pricingTiers.map((tier) => (
          ...
          >
            ...
            <div className="mb-6 flex items-baseline">
              ...
              <span className="ml-1 text-gray-500 dark:text-gray-400">{t("perMonth")}</span>
            </div>
