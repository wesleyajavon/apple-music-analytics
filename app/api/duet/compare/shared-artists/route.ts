...
import { getCompareSharedArtists } from "@/lib/services/duet/compare-service";

export const dynamic = "force-dynamic";
export const runtime = "nodejs";

const ROUTE = "/api/duet/compare/shared-artists";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await getCompareSharedArtists(
      request,
      access.viewerId,
      access.friendUserId
    );
