...
| D10 | Texte légal consentement partage | Aligné privacy § Duet + `duet.consent.short` — auto-évaluation interne (pas de conseil externe) | ✅ Validé internement 2026-06-09 — `DUET_SHARING_CONSENT_VERSION` = `2026-06-09` |
...
- [x] D8 validée
- [x] D9 validée
- [x] D10 validée (auto-évaluation interne 2026-06-09) — voir [GDPR_ROPA.md](./GDPR_ROPA.md), [GDPR_DPIA_DUET.md](./GDPR_DPIA_DUET.md), privacy `legal.privacy`
...
Contexte : ligne sous le bouton « Accepter » ou dans Paramètres → Partage Duet. Texte aligné avec la politique de confidentialité (section Duet, 2026-06-09).
...
| 0.3 Texte consentement | ✅ §2.3 + privacy Duet — version `2026-06-09` |
| 0.4 Entrée sidebar (libellé + icône) | Phase 4 — suggestion : groupe « Social », icône `Users` ou `GitCompare` |

**Actions humaines RGPD Duet** : ROPA, DPIA et privacy mis à jour (2026-06-09) — voir [GDPR_ROPA.md](./GDPR_ROPA.md), [GDPR_DPIA_DUET.md](./GDPR_DPIA_DUET.md). Revue externe différée ([GDPR_BACKLOG.md](./GDPR_BACKLOG.md)).
