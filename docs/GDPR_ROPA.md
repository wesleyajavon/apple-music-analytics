...
| **Partage Duet (amis)** | Comparaison de stats d’écoute **et** consultation lecture seule du Your Music ami, entre utilisateurs connectés ayant accepté une relation | **Consentement explicite** (acceptation invitation par ami ; révocation = off) | Statut relation, partage on/off ; nom/avatar ami ; agrégats d’écoute (timeline, tops artistes/genres/titres) ; **consultation du Your Music ami** ; comparaisons artiste/titre/genre | Durée du compte ; relation et accès supprimés à la révocation, au blocage ou à la suppression de compte | Supabase ; **autres utilisateurs amis autorisés** (accès lecture après acceptation) |
