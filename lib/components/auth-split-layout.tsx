...
export function AuthSplitLayout({ children }: AuthSplitLayoutProps) {
  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col bg-[#050508] text-white lg:grid lg:min-h-full lg:grid-cols-2 lg:bg-[#06070d]">
      ...
      <div className="relative z-10 flex min-h-0 min-w-0 flex-1 flex-col lg:min-h-full">
        <div className="flex flex-1 flex-col px-6 pb-8 pt-24 sm:px-10 sm:pb-10 lg:items-end lg:px-0 lg:pb-12 lg:pl-8 lg:pr-[4.75rem] lg:pt-32 xl:pl-10">
          <div className="my-auto w-full max-w-[24rem] lg:max-w-[27rem]">
            <div className="auth-form-surface lg:rounded-[2rem] lg:border lg:border-white/10 lg:bg-white/[0.045] lg:p-8 lg:shadow-[inset_0_1px_0_0_rgb(255_255_255_/_0.08),0_32px_80px_-40px_rgb(0_0_0_/_0.65)] lg:backdrop-blur-2xl xl:p-10 [&_.text-muted]:text-white/55">
              {children}
            </div>

            <footer className="mt-6 px-1 text-center text-xs text-white/40 lg:mt-8 lg:text-left">
              <Link
                href="/legal/terms"
                className="font-medium text-white/65 underline-offset-2 transition-colors hover:text-white"
              >
                {t("termsLink")}
              </Link>
