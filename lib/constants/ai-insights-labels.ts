...
> = {
  fr: {
    metrics: {
      totalListens: "Total de streams",
      uniqueArtists: "Artistes uniques",
      uniqueTracks: "Titres uniques",
      totalPlayTime: "Temps de streaming",
    },
    summary: {
      period: "Période",
      periodConnector: "à",
      ...
      listens: "streams",
      activeHours: "Heures de streaming les plus actives (top 5)",
      topArtists: "Artistes les plus streamés (top 10)",
    ...
    genreTrends: {
      ...
      filterAllData: "filtre temporel : toute l'historique disponible (bornes min/max des streams)",
      ...
      totalListens: "streams totaux sur la période",
      shareOfSelection: "part parmi les genres sélectionnés pour l'analyse (%)",
      deltaVsFirstHalf: "variation 2e moitié vs 1re moitié (streams et % relatif à la 1re moitié)",
      ...
      genresCappedNote:
        "Limite : seuls les genres les plus streamés parmi la sélection sont analysés (top par volume).",
    ...
    artistTrends: {
      ...
      timelineNoteDownsampled:
        "Série temporelle : échantillonnage uniforme des buckets pour limiter la taille du contexte ; les totaux et comparaisons 1re/2e moitié restent calculés sur la série complète.",
      artistsCappedNote:
        "Limite : seuls les artistes les plus streamés parmi la sélection sont analysés (top par volume).",
      bucketsInSeries: "Nombre de buckets dans la série",
  ...
  en: {
    ...
    summary: {
      ...
      listens: "streams",
      activeHours: "Most active streaming hours (top 5)",
      topArtists: "Top streamed artists (top 10)",
    ...
    genreTrends: {
      ...
      filterAllData: "time filter: full streaming history (min/max stream dates)",
      ...
      totalListens: "total streams in range",
      shareOfSelection: "share among analyzed selected genres (%)",
      deltaVsFirstHalf: "2nd half vs 1st half change (streams and % vs first half)",
  ...
  es: {
    metrics: {
      ...
      totalPlayTime: "Tiempo total de streaming",
    },
    summary: {
      period: "Período",
      periodConnector: "a",
      ...
      listens: "streams",
      activeHours: "Horas más activas de streaming (top 5)",
      topArtists: "Artistas más streameados (top 10)",
    ...
    genreTrends: {
      ...
      filterAllData: "filtro temporal: todo el historial disponible (fechas min/max de streams)",
      ...
      totalListens: "streams totales en el rango",
      shareOfSelection: "parte entre los géneros seleccionados analizados (%)",
      deltaVsFirstHalf: "cambio 2ª mitad vs 1ª mitad (streams y % respecto a la 1ª mitad)",
      ...
      genresCappedNote:
        "Límite: solo se analizan los géneros más streameados de la selección (top por volumen).",
    ...
    artistTrends: {
      ...
      timelineNoteDownsampled:
        "Línea temporal: muestreo uniforme de buckets para limitar el contexto; totales y mitades se calculan sobre la serie completa.",
      artistsCappedNote:
        "Límite: solo se analizan los artistas más streameados de la selección (top por volumen).",
      bucketsInSeries: "Buckets en la serie",
